...
parser.add_argument("--data_dir", "-dd", type=str, default="/data/home/hemantmishra/jaydeep_model/Co-GAT/dataset/mastodon_updated")
...
var_utt, var_adj, var_adj_full, var_adj_R, var_sent, var_act = [], [], [], [], [], []
data_train = (var_utt, var_adj, var_adj_full, var_adj_R, var_sent, var_act)

for epoch in range(0, args.num_epoch + 1):
    print("Training Epoch: {:4d} ...".format(epoch), file=sys.stderr)

    train_loss, train_time = training(model, data_house.get_iterator("train", args.batch_size, True), data_train,
