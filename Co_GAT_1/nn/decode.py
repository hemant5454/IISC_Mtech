...
class RelationDecoder(nn.Module):
    ...
    def forward(self, input_h, adj_re):
        ...
        pred_sent_act = torch.cat((linear_s, linear_a), dim=2)
        return pred_sent_act
    ...
    def forward_(self, input_h):
        ...
        #hem_code
        linear_s = self._sent_linear(input_h)
        linear_a = self._act_linear(input_h)
